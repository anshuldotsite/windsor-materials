        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          <div>
            <h2 className="text-4xl md:text-5xl font-light text-[#243b64] mb-6 leading-tight">
              We prioritize your budget and style with transparent pricing,
              quality materials with free custom quotes
            </h2>
          </div>
          ...
          <div className="grid grid-cols-3 gap-12">
            ...
            <div>
              <div className="text-5xl font-light text-[#243b64] mb-2">
                200+
              </div>
              <div className="text-xs text-[#9CA3AF] uppercase tracking-wider">
                Models
